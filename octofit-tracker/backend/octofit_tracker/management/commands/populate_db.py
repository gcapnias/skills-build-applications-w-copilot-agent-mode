...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create teams
        blue_team = {"_id": ObjectId(), "name": "Blue Team", "members": [users[0]["_id"], users[1]["_id"]]}
        gold_team = {"_id": ObjectId(), "name": "Gold Team", "members": [users[2]["_id"], users[3]["_id"], users[4]["_id"]]}
